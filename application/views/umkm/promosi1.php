...
<div class="card">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-bordered" id="dataTable">
                <thead>
                    <tr>
                    <th>Nama Pemilik</th>
                                <th>Fasilitas Promosi</th>
                                <th>Hambatan</th>
                                <th>Bantuan</th>
                                <th> Bazar Ramadhan</th>
                                <th>Pelatihan Online</th>
                                <th>Actions</th>
            ...
            <?php foreach ($promosis as $promosi): ?>
                <?php if ($user->username == $promosi->username): ?>
                    <tr>
                        <td><?= $user->fullname ?></td>
                        <td><?= $promosi->fasilitasi_promosi ?></td>
                        <td><?= $promosi->hambatan_memasarkan_produk ?></td>
                        <td><?= $promosi->bantuan_dibutuhkan ?></td>
                        <td><?= $promosi->berminat_bazar_ramadhan ?></td>
                        <td><?= $promosi->berminat_pelatihan_online ?></td>
                <td>
                            <div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <button class="dropdown-item btn btn-edit" data-toggle="modal" data-target="#editModal" data-promosiid="<?= $promosi->id ?>"
        ...
        <button class="dropdown-item btn btn-delete" data-promosiid="<?= $promosi->id ?>">
...
$query = "SELECT u.username, u.fullname FROM users u LEFT JOIN promosi_pemasaran m ON u.username = m.username WHERE m.username IS NULL";
...
$(document).ready(function() {
    ...
    $('.btn-edit').click(function() {
        ...
        var additionalText = $(this).data('edit_additionalText'); // Menambahkan data textarea yang sudah ada
    ...
    $('#updatePromosiBtn').on('click', function () {
        ...
        // var fasilitasiPromosi = $('input[name="fasilitasi_promosi"]:checked').val();
        if (id.trim() === '') {
            Swal.fire({
                icon: 'error',
                title: 'Error',
            ...
            // formData.append('fasilitasi_promosi', fasilitasiPromosi);
            $.ajax({
                type: 'POST',
